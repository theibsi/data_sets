...
## Acknowledgments
This dataset is based on the CT image and contours of the STS-001 set of the Soft-tissue-Sarcoma collection that was uploaded to the Cancer Imaging Archive.
